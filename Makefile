...
pkgdatadir = $(datadir)/mirovia
pkgincludedir = $(includedir)/mirovia
pkglibdir = $(libdir)/mirovia
pkglibexecdir = $(libexecdir)/mirovia
...
CONFIG_CLEAN_FILES = config/common.mk config/config.mk \
	config/dirtargets.mk config/targets.mk
...
PACKAGE_STRING = MIROVIA 1.0.0
PACKAGE_TARNAME = mirovia
PACKAGE_URL = 
...
config/common.mk: $(top_builddir)/config.status $(top_srcdir)/config/common.mk.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
config/config.mk: $(top_builddir)/config.status $(top_srcdir)/config/config.mk.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
config/dirtargets.mk: $(top_builddir)/config.status $(top_srcdir)/config/dirtargets.mk.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
config/targets.mk: $(top_builddir)/config.status $(top_srcdir)/config/targets.mk.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
