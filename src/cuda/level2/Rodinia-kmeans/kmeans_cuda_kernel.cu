////////////////////////////////////////////////////////////////////////////////////////////////////
// file:	altis\src\cuda\level2\kmeans\kmeans_cuda_kernel.cu
//
// summary:	Kmeans cuda kernel class
// 
// origin:  Rodinia(http://rodinia.cs.virginia.edu/doku.php)
////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef _KMEANS_CUDA_KERNEL_CU_
#define _KMEANS_CUDA_KERNEL_CU_
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// <summary>	A macro that defines assumed nr clusters. </summary>
///
/// <remarks>	Edward Hu (bodunhu@utexas.edu) 5/20/2020. </remarks>
////////////////////////////////////////////////////////////////////////////////////////////////////

#define CONST_MEM_SIZE 16384
...
__constant__ float c_clusters[CONST_MEM_SIZE];		/* constant memory for cluster centers */

/* ----------------- invert_mapping() --------------------- */

////////////////////////////////////////////////////////////////////////////////////////////////////
/// <summary>	inverts data array from row-major to column-major.
///
...
/// [dim2, p0][dim2, p1][dim2, p2] .... </summary>
///
/// <remarks>	Edward Hu (bodunhu@utexas.edu) 5/20/2020. </remarks>
///
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// <summary>	find the index of nearest cluster centers and change membership. </summary>
///
/// <remarks>	Edward Hu (bodunhu@utexas.edu) 5/20/2020. </remarks>
///
...
/// <param name="block_clusters">	[in,out] If non-null, the block clusters. </param>
/// <param name="block_deltas">  	[in,out] If non-null, the block deltas. </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
